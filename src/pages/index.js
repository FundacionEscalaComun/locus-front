					...
					<Swiper
						...
						<SwiperSlide>
							<div className='banner'>
								<Image src="/img/inicio/home-carrusel-01.jpg" layout='fill' objectFit='cover' alt='banner anímate a participar' />
							</div>
						</SwiperSlide>
						<SwiperSlide>
					...
					<div className='max-w-screen-md mx-8 lg:mx-auto flex flex-col justify-between pb-8'>
						<div>
							...
							<p className='pl-16 lg:pl-24'>
								...
								<a href='/descargas/congreso/Actividades.pdf' className='button text-sm font-semibold lg:ml-4' target='_blank'><span className='descarga'>DESCARGA EL<br className='lg:hidden' /> PROGRAMA</span></a>
							</p>
						</div>
						<div className='mt-14'>
							...
							<p className='pl-16 lg:pl-24'>
								...
								<a href='/descargas/intervenciones/Actividades.pdf' className='button text-sm font-semibold lg:ml-4' target='_blank'><span className='descarga'>DESCARGA EL<br className='lg:hidden' /> PROGRAMA</span></a>
							</p>
						</div>
					</div>
				</section>
